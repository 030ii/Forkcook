...
public class QnaController {
	...
	@RequestMapping("/main/{qnauser}/{listpartnermyqna}.do")
	public ModelAndView list(@PathVariable String listpartnermyqna, @PathVariable String qnauser, @RequestParam(value="pageNum",defaultValue="1") int currentPage) {
	...
	@RequestMapping("/admin/qna/{listpartnermyqna}.do")
	public ModelAndView list(@PathVariable String listpartnermyqna, @RequestParam(value="pageNum",defaultValue="1") int currentPage, HttpSession session) {
		ModelAndView model = new ModelAndView();
